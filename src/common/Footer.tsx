...
const Footer: React.FC = () => {
    return(
       ...
       <div className="bg-secondary-detailsBackground py-16 px-8 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div className="">
        <h1 className="uppercase text-2xl text-primary-blueText py-2">Get in Touch</h1>
        ...
        <div className="">
            <h1 className="uppercase text-2xl text-primary-blueText py-2">For update</h1>
            <input type="text" name="email" placeholder="E-mail" className="border-2 border-primary-blueText px-6 py-2 rounded my-2 w-[80%]"/>
            <div className="">
            <button className="rounded px-6 py-2 bg-red-800 text-white text-sm">Subscribe</button>
            </div>
           <div className="flex items-center text-primary-blueText lg:mt-8 lg:ml-12">
       ...
       <div className="flex flex-col md:flex-row justify-between py-8 px-4 md:px-12">
        ...
        <MdOutlineCopyright className="w-5 h-5 text-primary-blueText mr-2"/>
         <p className="text-base text-primary-blueText">2023 Tamang Library. All right reserved</p>
        </div>
         <div className="flex items-center ">
            <p className="text-base text-primary-blueText mr-2">Designed and developed by</p>
