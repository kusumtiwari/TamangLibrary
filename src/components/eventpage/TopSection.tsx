const TopSection: React.FC = () => {
  return (
    <div className="bg-[url('../../public/img/common/EventPageBg.png')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center h-[65vh] px-6 md:px-24 lg:px-36">
      <div className="px-6">
