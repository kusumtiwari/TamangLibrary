...
const NewArrivals: React.FC = () => {
  ...
  return (
    <div className="bg-secondary-detailsBackground text-primary-blueText px-16">
      ...
      <AliceCarousel
        ...
        renderPrevButton={() => {
            return(
                <button className={`px-1 py-1 mr-10 md:mr-6 lg:mr-0 rounded-md ${isLeftbtnClicked ? 'border border-primary-blueText' : 'bg-gray-300'}  mt-6 absolute bottom-0 right-[20%]`} onClick={onLeftbtnClick}>
        ...
        renderNextButton={() => {
            return(
                <button className={`px-1 py-1 rounded-md ${isRightbtnClicked ? 'border border-primary-blueText' : 'bg-gray-300'} mt-6 absolute bottom-0 right-[16%]`} onClick={onRightbtnClick}>
    ...
    >
        {
            myNewArrivals.map((items) => {
                return(
                    ...
                    <img src={items.image} alt="newarrival-book" className="my-8"/>
                   ...
                   <h1 className="ml-2">{items.author}</h1>
                    ...
                    <h1 className="w-[90%] py-5">{items.description}</h1>
                    </div>
                )
            })
        }
