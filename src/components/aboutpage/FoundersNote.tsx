        ...
        <AliceCarousel disableButtonsControls infinite mouseTracking>
          {myFoundersNoteContent.map((item) => {
            return (
              <div
                key={item.id}
                className="flex justify-between items-center text-primary-blueText flex-col-reverse md:flex-row"
              >
                <div className="w-[90%] md:w-[60%] pt-8 lg:mt-0">
                  <p className="font-kameron text-xl text-black w-[100%] md:w-[90%] text-justify">
                    {item.description}
                  </p>
