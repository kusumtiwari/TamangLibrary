						...
						{firstThreeProjects?.map((item, index: number) => {
							return (
								...
								>
									...
									<div className="w-[100vw] h-[55vh] md:h-[70vh] lg:h-[80vh] relative">
										<img
											src={item.image}
											alt="ongoing-project"
									...
									<div className="w-[100%] font-kameron px-6 md:px-16 pt-6">
										<h1
											className="text-black font-bold text-2xl cursor-pointer py-6 font-kameron"
											style={{ letterSpacing: "2px" }}
										>
											{item.title}
										</h1>
										...
										<div className="flex text-xl">
											<IoLocationOutline className="w-8 h-8 sm:w-6 sm:h-6" />
											<h1
												className="ml-2 text-black text-xl font-kameron"
										...
										<div className="flex my-6 text-xl">
											<SlCalender className="w-6 h-6 font-extrabold" />
											<h1
												className="ml-2 text-black font-kameron"
												style={{ letterSpacing: "1px" }}
											>
												{dayjs
