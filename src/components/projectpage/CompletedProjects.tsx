...
const CompletedProjects: React.FC = () => {
	...
	return (
		<div className="text-primary-blueText my-12 bg-secondary-detailsBackground w-full font-playfair">
			<h1
				className="uppercase text-4xl lg:text-5xl font-bold pb-4 text-center text-with-shadow font-perpetua"
			...
			<div className="py-12">
				{!isViewMoreBtnClicked
					? firstTwoProjects?.map((items: any, index: number) => {
							return (
								<div
									className={`flex py-8 flex-col lg:flex-row justify-between w-[100%] px-4 md:px-12 ${
								...
								>
									<div
										className="w-[95%] md:w-[60%] lg:w-[40%] h-[46vh] my-auto relative object-cover"
									...
									<div className="w-[95%] md:w-[75%] lg:w-[50%] playfair-display pt-6 lg:pt-0 flex flex-col">
										...
										<div
											className="py-8 text-justify text-black font-semibold"
