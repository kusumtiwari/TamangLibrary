...
const LibraryDetails: React.FC = () => {
  ...
  const handlePublicationNavigation = () => navigate("/publications");
  return (
    <>
      <div className="px-8 md:px-12 lg:px-16 py-8 flex justify-between text-primary-blueText flex-col md:flex-row">
      ...
      <div className="mt-8" onClick={handlePublicationNavigation}>
        <ViewmoreBtn />
      </div>
    </>
  );
