...
const OurCollection: React.FC = () => {
	...
	return (
		<div className="my-16 relative h-[90vh]">
			<h1
				className="font-thin uppercase text-primary-blueText text-4xl lg:text-5xl text-center h-[60%] text-with-shadow pt-12 bg-secondary-detailsBackground font-perpetua px-2"
				style={{ letterSpacing: "4px" }}
			>
				Our Collection
			</h1>
			<div className="bg-transparent lg:mx-6 absolute top-[25%] md:top-[30%] w-[98%]">
				<AliceCarousel
					mouseTracking
