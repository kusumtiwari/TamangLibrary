...
const myTestimonials: Testimonials[] = [
	...
	{
		id: 3,
		image: "/img/LibraryDetailsImage/LibraryDetailsimg2.png",
		description:
	...
	{
		id: 4,
		image: "/img/LibraryDetailsImage/LibraryDetailsimg3.png",
		description:
	...
	},
	{
		...
		image: "/img/Testimonial-image1.png",
		description:
			"When I embarked on the journey of preparing my thesis, I wasnot sure where to start. Then, I discovered Tamang Library Lekhnath Paudyal is regarded as the founding father of modern Nepali poetry litrerature (Kabi Shiromani) in the twentieth. The best of Lekhnaths poems adhered to the old-fashioned conventions of Sanskrit poetics (kavya).When I embarked on the journey of preparing my thesis, I wasnt sure where to start. Then, I discovered Tamang Library. Not only did I find the materials that were instrumental for my research, but I was also greeted with invaluable guidance and support from the wonderful people there",
		name: "Krishna Murari Gautam ",
	},
];
	...
	return (
		<div className="mt-24">
			...
			<div className="px-8 md:px-16 lg:px-24 py-16 bg-secondary-detailsBackground">
				<div className="h-[98vh] md:h-[60vh] lg:h-[50vh]">
					<TestimonialsHeader
